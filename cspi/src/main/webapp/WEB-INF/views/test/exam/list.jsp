			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<div class="chart-area">
						...
						<canvas id="myAreaChart" width="641" height="320"
							style="display: block; width: 641px; height: 320px;"
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<div class="chart-pie pt-4 pb-2">
						...
						<canvas id="myPieChart" width="288" height="245"
							style="display: block; width: 288px; height: 245px;"
							class="chartjs-render-monitor"></canvas>
					</div>
